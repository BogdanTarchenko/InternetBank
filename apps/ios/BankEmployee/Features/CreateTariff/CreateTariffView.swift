...
struct CreateTariffView: View {
    @Bindable var viewModel: CreateTariffViewModel
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: Layout.formSpacing) {
                    ...
                    Text(Strings.rateLabel)
                        ...
                        .foregroundStyle(.secondary)
                        .padding(.leading, Layout.fieldLabelLeading)
                    TextField(Strings.ratePlaceholder, text: $viewModel.rateText)
...
private extension CreateTariffView {
    enum Layout {
    ...
    enum Strings {
        static let title = "Новый тариф"
        static let nameLabel = "Название"
        static let namePlaceholder = "Название тарифа"
        static let rateLabel = "Процентная ставка (% годовых)"
        static let ratePlaceholder = "0"
